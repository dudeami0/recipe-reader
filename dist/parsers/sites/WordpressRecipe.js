...
export class WordpressRecipe extends ReplacementParser {
    ...
    total_time() {
        const ele = this.querySelector(".wprm-recipe-total_time, .wprm-recipe-total_time-minutes");
        return normalizeElement(ele);
    }
    image() {
        const ele = this.querySelector(".wprm-recipe-image img");
        return (normalizeElement(ele, "src") || normalizeElement(ele, "data-src"));
    }
    yields() {
...
//# sourceMappingURL=WordpressRecipe.js.map