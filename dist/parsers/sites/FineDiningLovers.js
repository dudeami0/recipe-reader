...
export class FineDiningLovers extends ReplacementParser {
    ...
    yields() {
        const ele = this.querySelector("div.field--name-field-recipe-serving-num");
        return normalizeElement(ele);
    }
    ingredients() {
        const eles = this.querySelectorAll("div.ingredients-box div.paragraph--type--recipe-ingredient");
        return normalizeNodeList(eles);
    }
    instructions() {
        const eles = this.querySelectorAll("div.field--name.field-recipe-para-steps " +
...
//# sourceMappingURL=FineDiningLovers.js.map