...
export class Vegolosi extends ReplacementParser {
    title() {
    ...
    ingredients() {
        const eles = this.querySelectorAll(".tasty-recipe-ingredients>ul>li,li.ingredient");
...
//# sourceMappingURL=Vegolosi.js.map