...
export class LAtelierDeRoxane extends ReplacementParser {
    ...
    before_parse() {
        this.blocs = this.querySelectorAll("div.bloc_temps.bloc_blog div.infos span.valeur");
    }
    image() {
        const ele = this.querySelector("img.attachment-single.size-single.wp-post-image");
    ...
    instructions() {
        const eles = this.querySelectorAll("div.bloc_texte_simple.bloc_blog li");
        return normalizeNodeList(eles);
    }
}
//# sourceMappingURL=LAtelierDeRoxane.js.map