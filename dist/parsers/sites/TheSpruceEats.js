...
export class TheSpruceEats extends ReplacementParser {
    ...
    ingredients() {
        const eles = this.querySelectorAll("section.section--ingredients li.structured-ingredients__list-item, " +
            "section.section--ingredients li.ingredient");
        return normalizeNodeList(eles);
    }
    instructions() {
        const eles = this.querySelectorAll("section.section--instructions ol li");
        return normalizeNodeList(eles);
    }
}
//# sourceMappingURL=TheSpruceEats.js.map