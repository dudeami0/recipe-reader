...
export class MonsieurCuisine extends ReplacementParser {
    ...
    total_time() {
        const ele = this.querySelector("div.duration-information div.recipe-duration-total");
        return normalizeElement(ele);
    }
    yields() {
    ...
    ingredients() {
        const eles = this.querySelectorAll("div.recipe--ingredients-html-item.col-md-8 li");
...
//# sourceMappingURL=MonsieurCuisine.js.map