...
export class GeniusKitchen extends ReplacementParser {
    ...
    instructions() {
        const eles = this.querySelectorAll("div.directions-inner.container-xs ol li");
        return normalizeNodeList(eles).filter((ele) => ele.indexOf("Submit a Correct") !== -1);
    }
    ratings() {
...
//# sourceMappingURL=GeniusKitchen.js.map