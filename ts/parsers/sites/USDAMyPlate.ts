...
export class USDAMyPlate extends ReplacementParser {
    ...
    total_time() {
        const eles = this.querySelectorAll(
            "div.mp-recipe-full__overview.desktop:grid-col-5.grid-row " +
    ...
    yields() {
        const ele = this.querySelector(
            "div.mp-recipe-full__overview.desktop:grid-col-5.grid-row span",
            "Makes:"
        );
        if (ele) {
    ...
    image() {
        const ele = this.querySelector(
            "div.field.field--name-field-recipe-image" +
    ...
    ingredients() {
        const eles = this.querySelectorAll(
            "ul.field_items.ingredients.yyyyy li"
        );
    ...
    instructions() {
        const ele = this.querySelector(
            "div.clearfix.text-formatted.field.field--name-field-instructions" +
